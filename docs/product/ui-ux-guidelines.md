...
- At compact widths, the central chat remains primary; task and result surfaces become explicitly labeled drawers. The Artifact workspace may expand for data or automation work, but closing it must return to the current task.
