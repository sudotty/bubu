...
function ResultTable({ result, title, pinned, onTogglePinned }: { readonly result: LocalResult; readonly title: string; readonly pinned: boolean; readonly onTogglePinned: () => void }) {
