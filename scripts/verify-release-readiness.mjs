...
for (const value of ["Azure/artifact-signing-action@", "notarytool submit", "npm sbom", "attest-build-provenance@", "BUBU_AZURE_SUBSCRIPTION_ID", "--draft"]) if (!releaseWorkflow.includes(value)) failures.push(`signed release workflow missing ${value}`);
