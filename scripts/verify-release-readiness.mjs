...
for (const value of ["BLOCKED ON EXTERNAL EVIDENCE", "Developer ID identity", "signed update discovery", "clean-device", "bubu-bi", "release runbook"]) if (!readiness.includes(value)) failures.push(`release readiness document missing ${value}`);
