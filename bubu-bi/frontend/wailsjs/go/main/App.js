...
export function CancelLLMProcessing() {
  return window['go']['main']['App']['CancelLLMProcessing']();
}
...
export function IsLLMProcessing() {
  return window['go']['main']['App']['IsLLMProcessing']();
}
