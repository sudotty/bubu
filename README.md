...
- Not complete yet: explicit-row disclosure, reusable Agent definitions and workflow Agent steps, richer charts and reports, wall-clock/OS notifications, approval/side-effect workflow nodes, resumable partial runs, remote MCP/OAuth and explicitly approved MCP use, RAG, Hub/RBAC/sync, signing, and updates.
...
npm run smoke:mcp           # inspect a real isolated stdio MCP fixture without invoking it
